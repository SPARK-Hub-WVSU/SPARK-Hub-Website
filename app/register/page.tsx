...
function SelectChevron() {
  return (
    <div className="pointer-events-none absolute right-0 top-1/2 -translate-y-1/2">
      <svg
        className="w-4 h-4 text-[#022a34]/25"
        fill="none"
        viewBox="0 0 24 24"
        stroke="currentColor"
      >
        ...
        <div className="flex justify-center items-center text-center py-24 sm:py-52 md:py-72">
          <div>
            ...
            <p className="text-white/50 text-sm sm:text-base leading-relaxed max-w-sm mx-auto mt-6">
              Connect with innovators, researchers, and changemakers driving
          ...
          <div className="bg-white rounded-3xl p-10 max-w-md w-full text-center shadow-2xl">
            <div className="relative w-16 h-16 mx-auto mb-6">
              ...
              <div className="w-16 h-16 rounded-full border border-[#1de4af]/60 bg-[#1de4af]/10 flex items-center justify-center">
                <CheckIcon
                  className="w-8 h-8 text-[#378394]"
                  strokeWidth={1.5}
                />
              </div>
            </div>
            <h2 className="text-3xl font-bold text-[#022a34] mb-3">
              Thank You!
            </h2>
            <p className="text-[#022a34]/50 text-sm leading-relaxed mb-8">
              We've received your registration and will be in touch with next
              steps shortly.
            </p>
            <button
              onClick={() => {
