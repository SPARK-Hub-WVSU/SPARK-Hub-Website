...
export default function Hero() {
  return (
    <section id ="Hero_Section" className="bg-[url('/bg/hero_bg.png')] bg-cover bg-center bg-no-repeat max-w-full min-h-screen -mt-32 pt-96">
        {/* Hero */}
        <div id="Title"
             className="flex flex-col items-center px-36 -mt-60
             ">
          ...
          {/* Lower-Part */}
          <div id="Lower_Part"
               className="grid grid-cols-3 place-items-center max-w-6xl mb-72"
          >
            <Image
              height={290}
              width={290}
